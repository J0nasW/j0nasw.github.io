...
<div class="hero-banner overlay">
    <video autoplay loop muted class="hero-banner video">
        <source src="assets/vid/deepmind_01.mp4" type="video/mp4">
        Your browser does not support the video tag.
    
      <div class="vertical-bottom">
        <p clas="hero-banner h3">Hey, my name is</p>
        <h1 clas="hero-banner h1">Jonas Wilinski</h1>
        <h3 clas="hero-banner h3">And this is my Website.</h3>
      </div>
    </video>
</div>
```
